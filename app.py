...
# Tratamento do Fuso e Regra de 5 Dias
if not df.empty:
...
# ==========================================
# 🛡️ BLINDAGEM CONTRA O KEYERROR AQUI:
# Garante que as colunas existam mesmo se a tabela estiver vazia
# ==========================================
